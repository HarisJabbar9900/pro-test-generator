...
async function main() {
  ...
  const ch5 = cs.chapters.find(c => c.chapterNumber === 5);
  if (!ch5) {
  ...
  console.log(`===========================================`);
  console.log(`Chapter 5 (Data Analytics) Verification:`);
  ...
  if (totalMcqs !== 46) {
    console.error(`ERROR: Expected 46 (38 topic + 8 exercise), got ${totalMcqs}`);
    process.exit(1);
  }
  ...
  console.log("Firestore successfully written and verified with 46 MCQs for Chapter 5!");
  process.exit(0);
}
