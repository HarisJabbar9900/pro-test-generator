...
async function main() {
  ...
  console.log(`===========================================`);
  console.log(`Chapter 8 (Online Research & Digital Literacy) Verification:`);
  ...
  if (totalMcqs !== 46) {
    console.error(`ERROR: Expected 46 (36 topic + 10 exercise), got ${totalMcqs}`);
    process.exit(1);
  }
  ...
  console.log("Firestore successfully written and verified with 46 MCQs for Chapter 8!");
  process.exit(0);
}
