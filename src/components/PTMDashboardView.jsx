...
export default function PTMDashboardView({
  ...
  return (
    <div className="p-2.5 sm:p-6 pb-24 sm:pb-8 max-w-7xl mx-auto font-sans min-h-full flex-1 flex flex-col justify-between w-full">
      ...
      {/* 🏛️ 1. ACADEMIC INSTITUTION & FACULTY WELCOME HEADER */}
      <div className="rounded-3xl bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 border border-indigo-500/30 text-white p-4 sm:p-6 shadow-xl shadow-indigo-950/20 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div className="flex items-start sm:items-center gap-3.5 sm:gap-4">
            <div className="w-13 h-13 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br from-blue-500 via-indigo-600 to-purple-600 flex items-center justify-center text-white shrink-0 shadow-lg shadow-indigo-600/30 border border-white/20">
              <GraduationCap className="w-7 h-7 sm:w-8 sm:h-8" />
            </div>
            
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2 flex-wrap">
                <span className="px-2.5 py-0.5 rounded-full bg-blue-500/20 text-blue-300 border border-blue-400/30 text-[10px] sm:text-xs font-black uppercase tracking-wider whitespace-nowrap">
                  Academic Session 2025–2026
                </span>
                <span className="px-2.5 py-0.5 rounded-full bg-emerald-500/20 text-emerald-300 border border-emerald-400/30 text-[10px] sm:text-xs font-extrabold flex items-center gap-1 whitespace-nowrap">
                  <CheckCircle2 className="w-3 h-3 text-emerald-400 shrink-0" />
                  {isUrdu ? 'بورڈ پیٹرن منظور شدہ' : 'Verified Board Pattern'}
                </span>
              </div>

              <h1 className="text-lg sm:text-2xl lg:text-3xl font-black text-white tracking-tight mt-1.5 break-words">
                {currentUser?.institute || 'Apex Model High School & College'}
              </h1>

              <div className="flex items-center gap-2 sm:gap-3 text-xs text-slate-300 mt-1 flex-wrap font-medium">
                <span className="text-amber-300 font-bold whitespace-nowrap">
                  👨‍🏫 {currentUser?.name || 'Faculty Member / Educator'}
                </span>
                <span className="text-slate-500 hidden sm:inline">•</span>
                <span className="text-slate-300 leading-relaxed">
                  {isUrdu ? 'امتحانی پورٹل: نہم، دہم، فرسٹ ایئر، سیکنڈ ایئر' : 'Punjab Boards (PBCC) & Federal (FBISE) Examination System'}
                </span>
              </div>
            </div>
          </div>

          {/* Quick Primary Action Buttons in Header */}
          <div className="flex items-center gap-2.5 shrink-0 flex-wrap sm:flex-nowrap pt-2 lg:pt-0 border-t lg:border-t-0 border-white/10 w-full sm:w-auto">
            <button
              type="button"
              onClick={onGoToGenerate}
              className="flex-1 sm:flex-none px-4 py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white text-xs sm:text-sm font-black transition-all shadow-md shadow-blue-600/30 active:scale-95 cursor-pointer flex items-center justify-center gap-2 whitespace-nowrap"
            >
              <Send className="w-4 h-4 shrink-0" />
              <span>{isUrdu ? 'نیا پرچہ بنائیں • New Exam' : 'Create Exam Paper'}</span>
            </button>
            ...
            {onOpenPairingSchemeModal && (
              <button
                ...
                className="flex-1 sm:flex-none px-4 py-2.5 rounded-xl bg-white/10 hover:bg-white/20 border border-white/20 text-white text-xs sm:text-sm font-bold transition-all active:scale-95 cursor-pointer flex items-center justify-center gap-2 whitespace-nowrap backdrop-blur-xs"
              >
        ...
        <div className="p-4 sm:p-5 rounded-2xl bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 text-white shadow-lg shadow-blue-500/15 flex flex-col sm:flex-row sm:items-center justify-between gap-4 animate-fadeIn border border-blue-400/30">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              ...
              <h3 className="text-base sm:text-lg font-black tracking-tight break-words">
              ...
              <p className="text-xs text-blue-100 font-medium mt-0.5 leading-relaxed break-words">
                {isUrdu 
          ...
          <div className="flex items-center gap-2 self-end sm:self-center shrink-0">
            {onDiscardDraft && (
              <button
                ...
                className="px-3 py-2 bg-white/10 hover:bg-white/20 text-white text-xs font-bold rounded-xl transition-all active:scale-95 cursor-pointer whitespace-nowrap"
                title="Discard Draft"
              >
            ...
            <button
              ...
              className="px-4 py-2 bg-white text-blue-700 hover:bg-blue-50 text-xs font-black rounded-xl shadow-md transition-all active:scale-95 cursor-pointer flex items-center gap-1.5 whitespace-nowrap"
            >
      ...
      {/* 2. LIVE BISE BOARD EXAM COUNTDOWN & PAIRING NOTIFICATION TICKER */}
      <div className="rounded-2xl bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 text-white p-3.5 sm:p-4 border border-indigo-500/25 shadow-md flex flex-col md:flex-row md:items-center justify-between gap-3 relative overflow-hidden">
        ...
        <div className="flex items-center gap-3 relative z-10">
          ...
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              <span className="text-xs font-black uppercase tracking-wider text-blue-300 whitespace-nowrap">
                BISE Exam Season 2026
              </span>
              <span className="px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-300 border border-emerald-400/30 text-[10px] font-extrabold flex items-center gap-1 whitespace-nowrap">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-ping"></span>
                {isUrdu ? '100% مستند پیئرنگ اسکیم فعال' : '100% Pairing Scheme Synchronized'}
              </span>
            </div>
            <p className="text-[11px] sm:text-xs text-slate-300 mt-0.5 font-medium leading-relaxed break-words">
              {isUrdu 
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 shrink-0 self-stretch md:self-auto relative z-10 w-full md:w-auto">
          ...
          <div className="grid grid-cols-2 gap-2 w-full sm:w-auto sm:flex sm:items-center">
            <div className="px-3 py-1.5 rounded-xl bg-white/10 border border-white/15 backdrop-blur-xs text-center flex-1 sm:flex-initial">
              ...
              <div className="text-[9px] font-bold text-white/80 whitespace-nowrap">
          ...
          <div className="grid grid-cols-2 gap-2 w-full sm:w-auto sm:flex sm:items-center">
            <button
              ...
              className="px-3 py-2 sm:py-2 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold transition-all shadow-sm active:scale-95 cursor-pointer flex items-center justify-center gap-1.5 w-full sm:w-auto whitespace-nowrap"
            >
            ...
            {onOpenPairingSchemeModal && (
              <button
                type="button"
                onClick={onOpenPairingSchemeModal}
                className="px-3 py-2 sm:py-2 rounded-xl bg-gradient-to-r from-amber-400 to-orange-500 hover:from-amber-300 hover:to-orange-400 text-slate-950 text-xs font-black transition-all shadow-sm active:scale-95 cursor-pointer flex items-center justify-center gap-1.5 w-full sm:w-auto whitespace-nowrap"
              >
                <Award className="w-3.5 h-3.5 text-slate-950 shrink-0" />
                <span>{isUrdu ? 'پیئرنگ اسکیم' : 'Pairing Scheme'}</span>
              </button>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2.5 sm:gap-4">
          ...
          >
            <div className="p-3.5 sm:p-5 flex items-center sm:items-start justify-between relative z-10">
              <div>
                ...
                <div className="text-sm font-bold mt-0.5 sm:mt-1 text-white/95 leading-snug">
                  Generate Paper
                  {isUrdu && <span className="block text-xs font-bold text-cyan-100 pb-0.5">امتحانی پرچہ تیار کریں</span>}
                </div>
                <p className="text-[11px] text-white/75 font-medium mt-0.5 leading-relaxed break-words">
                  Custom Exam Builder
            ...
            <div className="w-full py-2 sm:py-2.5 px-3.5 sm:px-4 bg-black/20 hover:bg-black/30 backdrop-blur-xs text-white text-xs font-bold flex items-center justify-between transition-colors border-t border-white/15">
              <span className="whitespace-nowrap">{isUrdu ? 'Generate Now • ابھی بنائیں' : 'Generate Now'}</span>
          ...
          >
            <div className="p-3 sm:p-5 flex items-start justify-between relative z-10">
              <div>
                ...
                <div className="text-xs sm:text-sm font-bold mt-1 text-white/95 leading-snug">
                  My Saved Papers
                  {isUrdu && <span className="block text-[10px] sm:text-xs font-bold text-emerald-100 pb-0.5">محفوظ شدہ پرچے</span>}
                </div>
                <p className="text-[10px] sm:text-[11px] text-white/75 font-medium mt-0.5 leading-relaxed break-words">
                  Ready to Print & PDF
            ...
            <div className="w-full py-2 sm:py-2.5 px-3 sm:px-4 bg-black/20 hover:bg-black/30 backdrop-blur-xs text-white text-[11px] sm:text-xs font-bold flex items-center justify-between transition-colors border-t border-white/15">
              <span className="whitespace-nowrap">{isUrdu ? 'Open Saved • پرچے' : 'Open Saved Papers'}</span>
              <ArrowRight className="w-3.5 h-3.5 shrink-0 group-hover:translate-x-1 transition-transform" />
            </div>
          </div>
          ...
          >
            <div className="p-3 sm:p-5 flex items-start justify-between relative z-10">
              <div>
                ...
                <div className="text-xs sm:text-sm font-bold mt-1 text-white leading-snug">
                  Created Papers
                  {isUrdu && <span className="block text-[10px] sm:text-xs font-bold text-amber-100 pb-0.5">کل تیار کردہ پیپرز</span>}
                </div>
                <p className="text-[10px] sm:text-[11px] text-white/80 font-medium mt-0.5 leading-relaxed break-words">
                  Generated Archives
            ...
            <div className="w-full py-2 sm:py-2.5 px-3 sm:px-4 bg-black/20 hover:bg-black/30 backdrop-blur-xs text-white text-[11px] sm:text-xs font-bold flex items-center justify-between transition-colors border-t border-white/15">
              <span className="whitespace-nowrap">{isUrdu ? 'History • تاریخچہ' : 'View History'}</span>
              <ArrowRight className="w-3.5 h-3.5 shrink-0 group-hover:translate-x-1 transition-transform" />
            </div>
          </div>
          ...
          >
            <div className="p-3 sm:p-5 flex items-start justify-between relative z-10">
              <div>
                ...
                <div className="text-xs sm:text-sm font-bold mt-1 text-white/95 leading-snug">
                  Remaining Quota
                  {isUrdu && <span className="block text-[10px] sm:text-xs font-bold text-rose-100 pb-0.5">باقی گنجائش</span>}
                </div>
                <p className="text-[10px] sm:text-[11px] text-white/75 font-medium mt-0.5 leading-relaxed break-words">
                  {isUnlimited 
                    ...
                    : `Limit: ${userMaxLimit}`}
                  {isUrdu && (
                    <span className="block text-[9px] sm:text-[10px] text-white/80 leading-relaxed">
            ...
            <div className="w-full py-2 sm:py-2.5 px-3 sm:px-4 bg-black/20 hover:bg-black/30 backdrop-blur-xs text-white text-[11px] sm:text-xs font-bold flex items-center justify-between transition-colors border-t border-white/15">
              <span className="whitespace-nowrap">{isSuper ? 'Admin Quota' : (isUnlimited ? 'Active Plan' : 'Manage Plan')}</span>
              <ArrowRight className="w-3.5 h-3.5 shrink-0 group-hover:translate-x-1 transition-transform" />
            </div>
          </div>
          ...
          >
            <div className="p-3 sm:p-5 flex items-start justify-between relative z-10">
              <div className="min-w-0 flex-1">
                <div className="text-sm sm:text-lg font-black tracking-tight drop-shadow-xs leading-snug break-words">
                  {isSuper ? 'Super Admin' : (currentUser?.package && currentUser?.package !== 'None' ? currentUser.package : 'Basic Plan')}
                </div>
                <div className="text-[11px] sm:text-xs font-bold mt-1 text-white/90 leading-snug break-words" title={currentUser?.institute}>
                  {currentUser?.institute || 'Educators Academy'}
                  {isUrdu && <span className="block text-[9px] text-purple-200 pb-0.5">ادارہ</span>}
                </div>

                {/* Expiry Date Badge inside Card 5 */}
                <div className="mt-1.5 sm:mt-2 inline-flex items-center gap-1 sm:gap-1.5 px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-lg bg-black/25 backdrop-blur-xs text-[10px] sm:text-[11px] font-bold text-amber-200 border border-white/10 whitespace-nowrap">
                  <Calendar className="w-3 h-3 text-amber-300 shrink-0" />
                  <span>{currentUser?.expiryDate || '31-12-2026'}</span>
                </div>
              </div>
            ...
            <div className="w-full py-2 sm:py-2.5 px-3 sm:px-4 bg-black/20 hover:bg-black/30 backdrop-blur-xs text-white text-[11px] sm:text-xs font-bold flex items-center justify-between transition-colors border-t border-white/15">
              <span className="whitespace-nowrap">{isUrdu ? 'Plan Details • تفصیل' : 'Plan Details'}</span>
              <ArrowRight className="w-3.5 h-3.5 shrink-0 group-hover:translate-x-1 transition-transform" />
            </div>
          </div>
      ...
      {/* 4. ⚡ 1-CLICK INSTANT EXAM PRESETS WITH ADMIN CUSTOMIZATION */}
      <div className="space-y-3 pt-1">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2 self-start sm:self-auto flex-wrap">
            {isSuper && (
              <span className="text-[10px] font-black uppercase tracking-wider text-purple-700 bg-purple-50 px-2.5 py-1 rounded-full border border-purple-200 flex items-center gap-1 shadow-2xs whitespace-nowrap">
                <ShieldCheck className="w-3 h-3 text-purple-600" />
                Admin Customizable
              </span>
            )}
            <span className="text-[10px] font-bold uppercase tracking-wider text-amber-800 bg-amber-50 px-2.5 py-1 rounded-full border border-amber-200 whitespace-nowrap">
            ...
            return (
              ...
              >
                <div>
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      {isSuper && (
                        <button
                          ...
                          className="p-1.5 rounded-lg bg-slate-100 hover:bg-purple-100 text-slate-500 hover:text-purple-700 transition-colors border border-slate-200/80 cursor-pointer shadow-2xs shrink-0"
                      ...
                      <div className="flex flex-col items-end">
                        <span className="px-2 py-0.5 rounded-full bg-slate-100 text-slate-800 text-[10px] font-black border border-slate-200 whitespace-nowrap">
                          {preset.marks} Marks
                        </span>
                        <span className="text-[10px] text-slate-400 font-bold mt-0.5 whitespace-nowrap">
                          ⏱️ {preset.time}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="mt-3">
                    <span className="text-[9px] font-black uppercase tracking-wider text-blue-600 bg-blue-50 px-2 py-0.5 rounded-md border border-blue-100 whitespace-nowrap inline-block">
                      {preset.badge}
                    </span>
                    <h3 className="text-sm font-black text-slate-800 group-hover:text-blue-600 transition-colors mt-1.5 leading-snug break-words">
                      {preset.title}
                    </h3>
                    <p className="text-[11px] text-slate-500 font-medium mt-0.5 leading-relaxed break-words">
                      {preset.desc}
                    </p>
                    {isUrdu && (
                      <p className="text-[11px] font-semibold text-slate-700 mt-1 leading-relaxed break-words pb-0.5">
                ...
                <div className="pt-3 mt-3 border-t border-slate-100 flex items-center justify-between text-xs font-bold text-blue-600 group-hover:text-blue-700">
                  <span className="whitespace-nowrap">{isUrdu ? 'یہ سانچہ منتخب کریں' : 'Use Template'}</span>
                  <div className="w-5 h-5 rounded-full bg-blue-50 group-hover:bg-blue-600 text-blue-600 group-hover:text-white flex items-center justify-center transition-colors shrink-0">
      ...
      {/* 5. 📄 RECENT PAPERS QUICK ACTIONS (INSTANT PRINT, DOCX, OPEN) */}
      <div className="space-y-3 pt-1">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
          ...
          <button
            type="button"
            onClick={() => handleNav('saved_papers')}
            className="text-xs font-bold text-blue-600 hover:text-blue-800 flex items-center gap-1 self-start sm:self-auto cursor-pointer hover:underline whitespace-nowrap"
          >
        ...
        {recentPapers.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
            {recentPapers.map((paper) => (
              ...
              >
                <div>
                  <div className="flex items-center justify-between gap-2 flex-wrap">
                    <div className="flex items-center gap-1.5 flex-wrap">
                      <span className="px-2 py-0.5 rounded-md bg-blue-50 text-blue-700 text-[10px] font-extrabold border border-blue-200 whitespace-nowrap">
                        {paper.subject}
                      </span>
                    ...
                    <span className="text-[11px] font-black bg-emerald-50 text-emerald-700 px-2 py-0.5 rounded-md border border-emerald-200 whitespace-nowrap">
                      {paper.totalMarks || 50} Marks
                    </span>
                  </div>

                  <h3 className="text-xs sm:text-sm font-bold text-slate-900 group-hover:text-blue-600 transition-colors mt-2.5 line-clamp-2 leading-snug break-words">
                ...
                <div className="flex items-center gap-2 pt-3 mt-3 border-t border-slate-100 flex-wrap sm:flex-nowrap">
                  <button
                    type="button"
                    onClick={() => {
                      if (onOpenSavedPaper) {
                    ...
                    className="flex-1 py-1.5 px-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-xs font-bold transition-all shadow-2xs active:scale-95 cursor-pointer flex items-center justify-center gap-1 whitespace-nowrap min-w-[65px]"
                  ...
                  <button
                    ...
                    className="flex-1 py-1.5 px-2 bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200 rounded-lg text-xs font-bold transition-all active:scale-95 cursor-pointer flex items-center justify-center gap-1 whitespace-nowrap min-w-[65px]"
                  ...
                  <button
                    ...
                    className="py-1.5 px-3 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg text-xs font-bold transition-all active:scale-95 cursor-pointer whitespace-nowrap"
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-slate-50 border border-slate-200 text-center flex flex-col items-center justify-center gap-2">
            ...
            <button
              type="button"
              onClick={onGoToGenerate}
              className="mt-1 px-4 py-1.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold transition-all shadow-xs cursor-pointer whitespace-nowrap"
            >
      ...
      {/* 6. 📚 BOARD CURRICULUM & ACADEMIC EXAMINATION STANDARDS */}
      <div className="space-y-3 pt-1">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
          <div>
            <h2 className="text-sm sm:text-base font-black text-slate-800 tracking-tight flex items-center gap-2">
              <Award className="w-4 h-4 text-emerald-600" />
              <span>Board Curriculum & Academic Standards</span>
              {isUrdu && <span className="text-xs font-bold text-emerald-600 font-sans">• امتحانی نصاب و بورڈ پیٹرن</span>}
            </h2>
            <p className="text-[11px] sm:text-xs text-slate-500 font-medium leading-relaxed">
              {isUrdu 
                ? 'پنجاب اور فیڈرل بورڈز کی آفیشل پیئرنگ اسکیم، حل شدہ ماڈل پیپرز اور 5 سالہ سابقہ ریکارڈ۔' 
                : 'Official PBCC & FBISE pairing schemes, solved model papers, smart syllabus, and 5-year archives.'}
            </p>
          </div>
          <span className="text-[10px] font-bold uppercase tracking-wider text-emerald-700 self-start sm:self-auto bg-emerald-50 px-2.5 py-1 rounded-full border border-emerald-200 whitespace-nowrap">
            {isUrdu ? '4 اہم امتحانی ذرائع • 4 Board Suites' : '4 Board Curriculum Suites'}
          </span>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-4">
          
          {/* Suite 1: Board Pairing Schemes (All Boards) */}
          <div 
            onClick={onOpenPairingSchemeModal}
          ...
          >
            <div className="flex items-start justify-between gap-2.5">
              ...
              <span className="flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-emerald-600 text-white text-[10px] font-black tracking-wide uppercase shadow-sm shadow-emerald-500/30 shrink-0 whitespace-nowrap">
            ...
            <div className="mt-3">
              <h3 className="text-sm font-black text-slate-800 group-hover:text-emerald-600 transition-colors tracking-tight leading-snug break-words">
              ...
              {isUrdu && (
                <p className="text-[11px] text-emerald-800 font-semibold mt-1 leading-relaxed break-words pb-0.5">
            ...
            <div className="flex items-center justify-between pt-2.5 mt-2.5 border-t border-slate-100 text-[11px] font-bold text-slate-600 group-hover:text-emerald-700 transition-colors">
              <span className="whitespace-nowrap">{isUrdu ? 'Open Scheme • پیئرنگ اسکیم کھولیں' : 'Open Pairing Scheme'}</span>
              <div className="w-5 h-5 rounded-full bg-slate-100 group-hover:bg-emerald-600 text-slate-400 group-hover:text-white flex items-center justify-center transition-all group-hover:translate-x-0.5 shadow-2xs shrink-0">
                <ChevronRight className="w-3.5 h-3.5" />
              </div>
            </div>
          </div>

          {/* Suite 2: Past Papers (5-Year Board Solved Archive) */}
          <div 
          ...
          >
            <div className="flex items-start justify-between gap-2.5">
              ...
              <span className="px-2.5 py-0.5 rounded-full bg-amber-50 text-amber-800 border border-amber-200 text-[10px] font-black tracking-wide shrink-0 shadow-2xs whitespace-nowrap">
                {isUrdu ? '5 سالہ ریکارڈ' : '5-Year Solved'}
              </span>
            </div>

            <div className="mt-3">
              <h3 className="text-sm font-black text-slate-800 group-hover:text-amber-600 transition-colors tracking-tight leading-snug break-words">
                Past Papers (Board Solved)
              </h3>
              <p className="text-[11px] text-slate-500 font-medium mt-0.5 leading-relaxed break-words">
                FBISE & Punjab Boards 5-Year Solved
              </p>
              {isUrdu && (
                <p className="text-[11px] text-amber-800 font-semibold mt-1 leading-relaxed break-words pb-0.5">
            ...
            <div className="flex items-center justify-between pt-2.5 mt-2.5 border-t border-slate-100 text-[11px] font-bold text-slate-600 group-hover:text-amber-700 transition-colors">
              <span className="whitespace-nowrap">{isUrdu ? 'Browse Past Papers • بورڈ پرچے' : 'Browse Past Papers'}</span>
              <div className="w-5 h-5 rounded-full bg-slate-100 group-hover:bg-amber-600 text-slate-400 group-hover:text-white flex items-center justify-center transition-all group-hover:translate-x-0.5 shadow-2xs shrink-0">
                <ChevronRight className="w-3.5 h-3.5" />
              </div>
            </div>
          </div>

          {/* Suite 3: Model Papers 2026 */}
          <div 
            onClick={() => handleNav('model_papers')}
          ...
          >
            <div className="flex items-start justify-between gap-2.5">
              ...
              <span className="flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-rose-500 text-white text-[10px] font-black tracking-wide uppercase shadow-sm shadow-rose-500/30 shrink-0 whitespace-nowrap">
                <span className="w-1.5 h-1.5 rounded-full bg-white animate-ping"></span>
                {isUrdu ? 'ماڈل 2026' : 'NEW 2026'}
              </span>
            </div>

            <div className="mt-3">
              <h3 className="text-sm font-black text-slate-800 group-hover:text-orange-600 transition-colors tracking-tight leading-snug break-words">
              ...
              {isUrdu && (
                <p className="text-[11px] text-orange-700 font-semibold mt-1 leading-relaxed break-words pb-0.5">
            ...
            <div className="flex items-center justify-between pt-2.5 mt-2.5 border-t border-slate-100 text-[11px] font-bold text-slate-600 group-hover:text-orange-700 transition-colors">
              <span className="whitespace-nowrap">{isUrdu ? 'Official Papers • ماڈل ٹیسٹ' : 'Official Model Papers'}</span>
              <div className="w-5 h-5 rounded-full bg-slate-100 group-hover:bg-orange-600 text-slate-400 group-hover:text-white flex items-center justify-center transition-all group-hover:translate-x-0.5 shadow-2xs shrink-0">
                <ChevronRight className="w-3.5 h-3.5" />
              </div>
            </div>
          </div>

          {/* Suite 4: Smart Syllabus */}
          <div 
          ...
          >
            <div className="flex items-start justify-between gap-2.5">
              ...
              <span className="px-2.5 py-0.5 rounded-full bg-blue-50 text-blue-700 border border-blue-200 text-[10px] font-black tracking-wide shrink-0 shadow-2xs whitespace-nowrap">
                2025–2026
              </span>
            </div>

            <div className="mt-3">
              <h3 className="text-sm font-black text-slate-800 group-hover:text-blue-600 transition-colors tracking-tight leading-snug break-words">
                Smart Syllabus & Scope
              </h3>
              <p className="text-[11px] text-slate-500 font-medium mt-0.5 leading-relaxed break-words">
                Curriculum Scope & PCTB Guidelines
              </p>
              {isUrdu && (
                <p className="text-[11px] text-blue-700 font-semibold mt-1 leading-relaxed break-words pb-0.5">
            ...
            <div className="flex items-center justify-between pt-2.5 mt-2.5 border-t border-slate-100 text-[11px] font-bold text-slate-600 group-hover:text-blue-700 transition-colors">
              <span className="whitespace-nowrap">{isUrdu ? 'Curriculum Scope • نصاب دیکھیں' : 'Curriculum Scope'}</span>
              <div className="w-5 h-5 rounded-full bg-slate-100 group-hover:bg-blue-600 text-slate-400 group-hover:text-white flex items-center justify-center transition-all group-hover:translate-x-0.5 shadow-2xs shrink-0">
                <ChevronRight className="w-3.5 h-3.5" />
              </div>
            </div>
          </div>
      ...
      {/* 7. 🛠️ EXAMINATION MANAGEMENT & ARCHIVAL CENTER */}
      <div className="space-y-3 pt-1">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
          <div>
            <h2 className="text-sm sm:text-base font-black text-slate-800 tracking-tight flex items-center gap-2">
              <Sliders className="w-4 h-4 text-indigo-600" />
              <span>Examination Management & Archival Center</span>
              {isUrdu && <span className="text-xs font-bold text-indigo-600 font-sans">• پرچہ سازی ریکارڈ اور انتظامی سہولیات</span>}
            </h2>
            <p className="text-[11px] sm:text-xs text-slate-500 font-medium leading-relaxed">
              {isUrdu 
                ? 'امتحانی ہیڈر، مونوگرام ترتیبات، پرانوں پرچوں کا ریکارڈ اور ڈرافٹ پیپرز کا انتظامی مرکز۔' 
                : 'Manage institute styling, watermarks, paper history, draft tests, and recycle bin.'}
            </p>
          </div>
          <span className="text-[10px] font-bold uppercase tracking-wider text-indigo-700 self-start sm:self-auto bg-indigo-50 px-2.5 py-1 rounded-full border border-indigo-200 whitespace-nowrap">
            {isUrdu ? '4 انتظامی ٹولز • 4 Admin Tools' : '4 Management Modules'}
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-4">
          ...
          >
            <div className="flex items-start justify-between gap-2.5">
              ...
              <span className="px-2.5 py-0.5 rounded-full bg-cyan-50 text-cyan-700 border border-cyan-200 text-[10px] font-black tracking-wide shrink-0 shadow-2xs whitespace-nowrap">
            ...
            <div className="mt-3">
              ...
              {isUrdu && (
                <p className="text-[11px] text-cyan-700 font-semibold mt-1 leading-relaxed break-words pb-0.5">
            ...
            <div className="flex items-center justify-between pt-2.5 mt-2.5 border-t border-slate-100 text-[11px] font-bold text-slate-600 group-hover:text-cyan-700 transition-colors">
              <span className="whitespace-nowrap">{isUrdu ? 'Configure System • ترتیبات' : 'Configure System'}</span>
              <div className="w-5 h-5 rounded-full bg-slate-100 group-hover:bg-cyan-600 text-slate-400 group-hover:text-white flex items-center justify-center transition-all group-hover:translate-x-0.5 shadow-2xs shrink-0">
                <ChevronRight className="w-3.5 h-3.5" />
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex items-start justify-between gap-2.5">
              ...
              <span className="px-2.5 py-0.5 rounded-full bg-purple-50 text-purple-700 border border-purple-200 text-[10px] font-black tracking-wide shrink-0 shadow-2xs whitespace-nowrap">
                {isUrdu ? `${savedPapers.length || 0} محفوظ` : `${savedPapers.length || 0} Saved`}
              </span>
            </div>

            <div className="mt-3">
              <h3 className="text-sm font-black text-slate-800 group-hover:text-purple-600 transition-colors tracking-tight leading-snug break-words">
              ...
              {isUrdu && (
                <p className="text-[11px] text-purple-700 font-semibold mt-1 leading-relaxed break-words pb-0.5">
            ...
            <div className="flex items-center justify-between pt-2.5 mt-2.5 border-t border-slate-100 text-[11px] font-bold text-slate-600 group-hover:text-purple-700 transition-colors">
              <span className="whitespace-nowrap">{isUrdu ? 'Open Drafts • ڈرافٹ کھولیں' : 'Open Drafts'}</span>
              <div className="w-5 h-5 rounded-full bg-slate-100 group-hover:bg-purple-600 text-slate-400 group-hover:text-white flex items-center justify-center transition-all group-hover:translate-x-0.5 shadow-2xs shrink-0">
                <ChevronRight className="w-3.5 h-3.5" />
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex items-start justify-between gap-2.5">
              ...
              <span className="px-2.5 py-0.5 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200 text-[10px] font-black tracking-wide shrink-0 shadow-2xs whitespace-nowrap">
            ...
            <div className="mt-3">
              ...
              {isUrdu && (
                <p className="text-[11px] text-emerald-700 font-semibold mt-1 leading-relaxed break-words pb-0.5">
            ...
            <div className="flex items-center justify-between pt-2.5 mt-2.5 border-t border-slate-100 text-[11px] font-bold text-slate-600 group-hover:text-emerald-700 transition-colors">
              <span className="whitespace-nowrap">{isUrdu ? 'View Archives • سابقہ ریکارڈ' : 'View Archives'}</span>
              <div className="w-5 h-5 rounded-full bg-slate-100 group-hover:bg-emerald-600 text-slate-400 group-hover:text-white flex items-center justify-center transition-all group-hover:translate-x-0.5 shadow-2xs shrink-0">
                <ChevronRight className="w-3.5 h-3.5" />
              </div>
            </div>
          ...
          >
            <div className="flex items-start justify-between gap-2.5">
              ...
              <span className="px-2.5 py-0.5 rounded-full bg-rose-50 text-rose-700 border border-rose-200 text-[10px] font-black tracking-wide shrink-0 shadow-2xs whitespace-nowrap">
                {isUrdu ? 'ری سائیکل بن' : 'Recycle Bin'}
              </span>
            </div>

            <div className="mt-3">
              <h3 className="text-sm font-black text-slate-800 group-hover:text-rose-600 transition-colors tracking-tight leading-snug break-words">
                Recycle Bin & Recovery
              </h3>
              <p className="text-[11px] text-slate-500 font-medium mt-0.5 leading-relaxed break-words">
                Paper Recovery & Trash Storage
              </p>
              {isUrdu && (
                <p className="text-[11px] text-rose-700 font-semibold mt-1 leading-relaxed break-words pb-0.5">
            ...
            <div className="flex items-center justify-between pt-2.5 mt-2.5 border-t border-slate-100 text-[11px] font-bold text-slate-600 group-hover:text-rose-700 transition-colors">
              <span className="whitespace-nowrap">{isUrdu ? '0 Items • ری سائیکل بن' : '0 Items in Bin'}</span>
              <div className="w-5 h-5 rounded-full bg-slate-100 group-hover:bg-rose-600 text-slate-400 group-hover:text-white flex items-center justify-center transition-all group-hover:translate-x-0.5 shadow-2xs shrink-0">
                <ChevronRight className="w-3.5 h-3.5" />
              </div>
            </div>
          </div>
      ...
      {/* 8. ADMIN CONTROL: USER MANAGEMENT BANNER (IF SUPER ADMIN) */}
      {isSuper && (
        <div 
        ...
        >
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span className="px-2.5 py-0.5 rounded-full bg-white/20 text-[10px] font-black uppercase tracking-wider border border-white/25 shadow-2xs whitespace-nowrap">
                  Admin Portal
                </span>
              </div>
              <p className="text-xs text-white/90 mt-0.5 font-medium leading-relaxed break-words">
                {isUrdu 
          ...
          <div className="flex items-center gap-2 self-start sm:self-auto bg-white/20 hover:bg-white/30 px-4 py-2 rounded-xl border border-white/25 text-xs font-bold shrink-0 transition-colors whitespace-nowrap">
      ...
      {/* 9. 🗄️ MASTER QUESTION BANK & CURRICULUM COVERAGE */}
            ...
            <div className="p-4 sm:p-5 flex items-start justify-between relative z-10">
              <div>
                ...
                <div className="text-sm font-bold mt-1 text-white">
                  MCQs Questions
                  {isUrdu && <span className="block text-[11px] font-semibold text-white/95 pb-0.5">معروضی سوالات (کثیر الانتخابی)</span>}
                </div>
            ...
            <div className="p-4 sm:p-5 flex items-start justify-between relative z-10">
              <div>
                ...
                <div className="text-sm font-bold mt-1 text-white/95">
                  Short Questions
                  {isUrdu && <span className="block text-[11px] font-semibold text-white/95 pb-0.5">مختصر امتحانی سوالات</span>}
                </div>
                <p className="text-[11px] text-white/75 font-medium mt-0.5 leading-relaxed">
          ...
          >
            <div className="p-4 sm:p-5 flex items-start justify-between relative z-10">
              <div>
                ...
                <div className="text-sm font-bold mt-1 text-white/95">
                  Long Questions
                  {isUrdu && <span className="block text-[11px] font-semibold text-white/95 pb-0.5">انشائیہ و تفصیلی سوالات</span>}
                </div>
                <p className="text-[11px] text-white/75 font-medium mt-0.5 leading-relaxed">
          ...
          >
            <div className="p-4 sm:p-5 flex items-start justify-between relative z-10">
              <div>
                ...
                <div className="text-sm font-bold mt-1 text-white/95">
                  Question Bank
                  {isUrdu && <span className="block text-[11px] font-semibold text-white/95 pb-0.5">مجموعی امتحانی ذخیرہ</span>}
                </div>
                <p className="text-[11px] text-white/75 font-medium mt-0.5 leading-relaxed">
            ...
            <div className="w-full py-2.5 px-4 bg-black/20 hover:bg-black/30 backdrop-blur-xs text-white text-xs font-bold flex items-center justify-between transition-colors border-t border-white/15">
              <span className="whitespace-nowrap">{isUrdu ? 'Use in Exam Builder • نیا ٹیسٹ' : 'Use in Exam Builder'}</span>
              <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-1 transition-transform shrink-0" />
            </div>
          </div>
      ...
      {/* 10. 🎖️ PLATFORM QUALITY & ACADEMIC TRUST METRICS STRIP */}
      <div className="pt-1">
        <div className="p-4 sm:p-6 rounded-3xl bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-950 text-white border border-slate-700/50 shadow-xl relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-white/10 pb-4 mb-4">
            <div>
              <span className="text-[10px] font-black uppercase tracking-wider text-cyan-400 bg-cyan-400/10 px-2.5 py-1 rounded-full border border-cyan-400/20 whitespace-nowrap">
                Gold Standard Examination Platform
              </span>
              <h3 className="text-base sm:text-lg font-black tracking-tight mt-1 break-words">
                Pakistan's Most Advanced Question Paper Management System
              </h3>
              {isUrdu && (
                <p className="text-xs text-indigo-200 mt-0.5 leading-relaxed break-words pb-0.5">
            ...
            <div className="flex items-center gap-2">
              <span className="flex items-center gap-1.5 text-xs font-bold text-emerald-400 bg-emerald-400/10 px-3 py-1.5 rounded-xl border border-emerald-400/20 whitespace-nowrap">
