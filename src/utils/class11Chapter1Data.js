...
export const CLASS_11_CHAPTER_1_TOPICS = [
  ...
  // =========================================================================
  {
    ...
    shortQuestions: [
      ...
      {
        id: "cs11-ch1-t1.8-s2",
        question: "What is an Integrated Development Environment (IDE)? Name two popular IDEs.",
        marks: 2
      }
    ],
    longQuestions: []
  ...
  // =========================================================================
  // TOPIC 1.9: OFFICIAL TEXTBOOK EXERCISE QUESTIONS (PAGES 18–19)
  // =========================================================================
  {
    id: "cs-11-ch1-topic-exercise",
    topicNumber: "1.9",
    name: "Textbook Exercise Questions (Pages 18–19)",
    mcqs: [
      {
        id: "cs11-ch1-tex-m1",
